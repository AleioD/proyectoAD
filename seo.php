<?php
$pageTitle = 'AD Web Technologies - Posicionamiento';
...
<div class="infoContainer col-md-12">
  <div class="infoInformation col-md-7">
    ...
    <br>
    <p>La optimización en motores de búsqueda (o <strong>SEO</strong>, por sus siglas en inglés) son las acciones orientadas a la mejora del posicionamiento de un sitio web en los resultados de los principales buscadores de internet, siendo Google el principal y más famoso.
  ...
  <div class="infoImage col-md-5">
    <img src="img/seo.jpg" alt="weImage">
  </div>
</div>
