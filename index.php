<?php
$pageTitle = 'AD Web Technologies - Sitios y programas web';
      ...
      <div class="services col-md-12">
        <div class="oneService">
          ...
          <div class="serviceName">
            <h4 style="font-size: 18px;"><strong>Hosting</strong></h4>
          </div>
        </div>
        <div class="oneService">
          <div class="serviceDescription">
          ...
          <div class="serviceName">
            <h4 style="font-size: 18px;"><strong>Desarrollo Web</strong></h4>
          </div>
        </div>
        <div class="oneService">
          <div class="serviceDescription">
          ...
          <div class="serviceName">
            <h4 style="font-size: 18px;"><strong>Diseño Responsive</strong></h4>
          </div>
        </div>
        <div class="oneService">
          <div class="serviceDescription">
          ...
          <div class="serviceName">
            <h4 style="font-size: 18px;"><strong>Posicionamiento</strong></h4>
          </div>
        </div>
      </div>
    </div>
